        ...
        switch(cmd){
            case '8ball':{
                ...
                try{
                    ...
                    .setImage(data.url)
                    .setThumbnail('https://telegra.ph/file/99a1fc1915c664fcd8a29.jpg')
                    .setFooter(`Tanjiro`)
                    .setTimestamp();
                ...
                case 'help':{
                  ...
                  embed.setTitle("😉 __**TANJIRO AUTOMATION**__ +®↓")
                  embed.setAuthor(' SELFBOT 🤩', "https://telegra.ph/file/99a1fc1915c664fcd8a29.jpg')", 'https://discord.js.org')
                  embed.setDescription('*FREE DISCORD TANJIRO SELFBOT + 150 COMMANDS.. ✔️*')
                                       
	
                  embed.addField("-• +__ɢᴇɴᴇʀᴀʟ__®|👫", "GENERAL COMMANDS")
                  embed.addField("-• +__ᴛᴇxᴛ__®|💬", "DISPLAYS TEXT COMMANDS")
                  embed.addField("-• +__ᴍᴏᴅᴇʀᴀᴛɪᴏɴ__®|💎", "DISPLAYS MODERATION COMMANDS")
                  embed.addField("-• +__ɪᴍᴀɢᴇ__®|📷", "DISPLAYS IMAGE COMMANDS")
                  embed.addField("-• +__ғᴜɴ__®|🎧", "DISPLAYS FUN COMMANDS")
                  embed.addField("-• +__ɴsғᴡ__®|🔒", "DISPLAYS NSFW COMMANDS")
                  embed.addField("-• +__Aᴀʙᴜsᴇ__®|✔️", "DISPLAYS ABUSE COMMANDS")
                  embed.setImage('https://telegra.ph/file/99a1fc1915c664fcd8a29.jpg')
	embed.setTimestamp()
	embed.setFooter(message.author.username, 'https://telegra.ph/file/99a1fc1915c664fcd8a29.jpg');
